...
class Classmate(Person):
    ...
    def introduce(self):
        print(f"""Привет, меня зовут {self.name}, я одноклассница Айзат, я родился {self.birth_date}, профессия - {self.occupation}""")
...
class Friend(Person):
    ...
    def introduce(self):
        print(f"""Привет, меня зовут {self.name}, я подруга Айзата, я родился {self.birth_date}, професия - {self.occupation}""")
        print(f"Моя хобби {self.hobby}")
